...
class WorkbookExportPlanTest(unittest.TestCase):
    ...
    def test_routes_stock_card_to_stocks_sheet_row(self) -> None:
        ...
        self.assertEqual(row["values"][6], "")
        self.assertEqual(row["values"][7], "10")
        self.assertEqual(row["values"][8], "4,30 EUR")
        self.assertEqual(row["values"][9], "2,70 EUR")
        self.assertEqual(row["values"][10], "new_recommendation")
        self.assertEqual(row["values"][11], "2026-W03")
        self.assertEqual(row["values"][12], "22")
        self.assertEqual(row["values"][13], "2026-05-17")

...
class WorkbookExportPlanTest(unittest.TestCase):
    ...
    def test_routes_stock_card_to_stocks_sheet_row(self) -> None:
        ...
        self.assertEqual(row["values"][6], "10")
        self.assertEqual(row["values"][7], "4,30 EUR")
        self.assertEqual(row["values"][8], "2,70 EUR")
        self.assertEqual(row["values"][9], "new_recommendation")
        self.assertEqual(row["values"][10], "2026-W03")
        self.assertEqual(row["values"][11], "22")
        self.assertEqual(row["values"][12], "2026-05-17")
